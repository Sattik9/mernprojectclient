  ...
  <div className="container-fluid page-header mb-5 p-0" style={{backgroundImage: 'url(img/carousel-1.jpg)'}}>
    <div className="container-fluid page-header-inner py-5">
      <div className="container text-center pb-5">
        <h1 className="display-3 text-white mb-3 animated slideInDown">Room Category</h1>
        <nav aria-label="breadcrumb">
          <ol className="breadcrumb justify-content-center text-uppercase">
            <li className="breadcrumb-item"><a href="#">Home</a></li>
            <li className="breadcrumb-item"><a href="#">Pages</a></li>
            <li className="breadcrumb-item text-white active" aria-current="page">Room Category</li>
          </ol>
        </nav>
      </div>
    </div>
  ...
  <div className="container-xxl py-5">
    <div className="container">
      <div className="text-center wow fadeInUp" data-wow-delay="0.1s">
        <h6 className="section-title text-center text-primary text-uppercase">Our Room Categories</h6>
        <h1 className="mb-5">Explore Our <span className="text-primary text-uppercase">Room Categories</span></h1>
      </div>
      <div className="row g-4">
        
        {
        all_data?.data?.result.map((item,index)=>{
            return(
                <>
          ...
          <div className="room-item shadow rounded overflow-hidden">
            ...
            <div className="p-4 mt-2">
              ...
              <div className="d-flex justify-content-between">
                ...
                <Link className="btn btn-sm btn-primary rounded py-2 px-4" to={`/roombycategory/${item._id}`}>View Category</Link>
              </div>
            </div>
          </div>
        </div>
