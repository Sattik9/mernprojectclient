...
const Blog = () => {
  ...
  const currentPosts = all_blogs?.data?.result?.slice(indexofFirstPost, indexOfLastPost);
  console.log(all_blogs?.data?.result);
  return (
    <>
      <div className="container-xxl bg-white p-0">
        <div className="container-fluid page-header mb-5 p-0" style={{ backgroundImage: 'url(img/carousel-1.jpg)' }}>
          <div className="container-fluid page-header-inner py-5">
            <div className="container text-center pb-5">
              <h1 className="display-3 text-white mb-3 animated slideInDown">Blog Category</h1>
              <nav aria-label="breadcrumb">
                <ol className="breadcrumb justify-content-center text-uppercase">
                  <li className="breadcrumb-item"><a href="#">Home</a></li>
                  <li className="breadcrumb-item"><a href="#">Pages</a></li>
                  <li className="breadcrumb-item text-white active" aria-current="page">Blog Category</li>
                </ol>
              </nav>
            </div>
          </div>
        ...
        <div className="container-xxl py-5">
          <div className="container">
            <div className="text-center wow fadeInUp" data-wow-delay="0.1s">
              <h6 className="section-title text-center text-primary text-uppercase">Our Blogs</h6>
              <h1 className="mb-5">Explore Our <span className="text-primary text-uppercase">Blogs</span></h1>
            </div>
            <div className="row g-4">
              {all_blogs?.data?.result !== null ? (
                <>
                              ...
                              <div className="room-item shadow rounded overflow-hidden">
                                ...
                                <div className="p-4 mt-2">
                                  ...
                                  <div className="d-flex justify-content-between">
                                    ...
                                    <Link className="btn btn-sm btn-primary rounded py-2 px-4" to={`/blogdetails/${item._id}`}>Read More</Link>
                                  </div>
                                </div>
                              </div>
                            </div>
        ...
        <ReactPaginate
          ...
          pageCount={Math.ceil(all_blogs?.data?.result?.length / postPerPage)}
          previousLabel="< previous"
          activeClassName={'active'}
          containerClassName={'pagination justify-content-center mx-2'}
