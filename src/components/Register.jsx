...
const Register = () => {
    const { redirectReg } = useSelector((state) => state?.auth);
      ...
      const handleSubmit=(e)=>{
            e.preventDefault();
            dispatch(registerUser({name,email,phone,password,answer,image}))
            history("/login");
          }
        // const redirectUser = () => {
  ...
  <div className="container">
    <div className="text-center wow fadeInUp" data-wow-delay="0.1s">
      <h6 className="section-title text-center text-primary text-uppercase">User Register</h6>
      <h1 className="mb-5"><span className="text-primary text-uppercase">Register</span></h1>
    </div>
